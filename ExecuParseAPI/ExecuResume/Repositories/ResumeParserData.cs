...
namespace ExecuResume.Repositories
{
    ...
    public class ResumeParserData
    {
        ...
        {
            SegQualification = new List<SegregateQualification>();
            SegExperience = new List<SegregateExperience>();
            SegSkills = new List<Skills>();
            CandidateImage = new CandidateImage();
        }
                                ...
                                case "CandidateImage":
                                    if (reader.NodeType == XmlNodeType.Element)
                                    {
                                        ...
                                        while (inner.Read())
                                        {
                                            ...
                                            {
                                                CandidateImage.CandidateImageFormat = inner.ReadElementString();
                                            }
                                            if (inner.Name.Equals("CandidateImageData"))
                                            {
                                                CandidateImage.CandidateImageData = inner.ReadElementString();
                                            }
                                        }
                                    }
